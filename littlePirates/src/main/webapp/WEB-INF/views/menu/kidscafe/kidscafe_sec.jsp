			...
			<div id="box">
				<div class="as_inner">
					...
					<nav id="lnb" class="lnb">
						<div id="sideSubBox">
							<div class="on">
								<img src="<c:url value='/images/지도.png' />" width="35"
									height="25"> <a href="/kidscafe_map">지도로 보기</a>
							</div>
							<div class="on">
								<img src="<c:url value='/images/간편하게.png' />" width="35"
									height="25"> <a href="/kidscafe_sec">간편하게 보기</a>
							</div>
						</div>
					</nav>
				</div>
					...
					<div id="firstresult" class="scroll_box">
						<table border="1" class="table" id="table">
							...
							<c:forEach var="mapInfo" items="${voList }" varStatus="status">
								...
								<td><img
									src="<c:url value='/images/${mapInfo.kcNo}.jpg' />"
									onerror="this.src='<c:url value='/images/logo.png'/>'"
									width="180" height="120"></td>
								<td>가게명: ${mapInfo.kcName }<br> 주소:
									${mapInfo.kcAddress}<br> 운영시간: <br> 전화번호:
									${mapInfo.kcphone }
								</td>
