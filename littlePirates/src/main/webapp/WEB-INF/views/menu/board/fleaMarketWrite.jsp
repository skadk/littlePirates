					...
					<div class="conwrapFleaMarket">
						<div class="board_write_wrap">
							<div class="section">
								...
								<div class="boxed">
									<input type="text" name="cont_nm" id="cont_nm" title="제목"
										...
										<div id="fleaMarketTextTableBox">
											<table border="1" width="340px" height="402px">
												<tr align="center">
													...
													<td>
													<input type="text" name="cont_mm" id="cont_mm" title="제목"
													maxlength="50" placeholder="상품명을 입력해주세요.">
													</td>
												</tr>
												<tr align="center">
													<td width= "100px" height= "30px">분류</td>
													<td>
														<input type="radio" name="condition" value="free">나눔 제품 
														<input type="radio" name="condition" value="flea">판매 제품
													</td>
												</tr>
												<tr align="center">
