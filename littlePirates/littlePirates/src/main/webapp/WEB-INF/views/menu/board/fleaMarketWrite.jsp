			...
			<div id="contents">
				<div id="mainBoardBox">
					...
					<form id="writeForm" name="writeForm" method="post"
						action="<c:url value='/fleaMarket/fleaMarketWrite'/>"
						...
						<div class="conwrapFleaMarket">
							<div class="board_write_wrap">
								...
								<div class="section">
									...
									<div>
										<div id="mainTwoBox">
											<div class="TextImg" id="fleaMarketImgUpload"></div>
											...
											<div id="fleaMarketTextTableBox">
												<table border="1" width="340px" height="402px">
													...
													<tr align="center">
														...
														<td><input type="radio" name="flCategory" value="나눔">나눔 제품 
															<input type="radio" name="flCategory" value="판매">판매 제품
														</td>
													</tr>
													<tr align="center">
